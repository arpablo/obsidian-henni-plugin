...
2. Open BRAT settings → _Add Beta plugin_.
3. Paste this repository URL and confirm: `https://github.com/arpablo/obsidian-henni-plugin`
4. BRAT will fetch the latest build and place it in your vault’s plugin folder.
5. Back in Obsidian, enable **Obsidian Henni Plugin** in _Settings → Community plugins_.
...
- Context menu entry _Open referenced source_ resolves wiki-links, vault-relative paths, or external URLs and opens them immediately.
- The same capability is exposed in the command palette via _Open referenced source for current note_.
